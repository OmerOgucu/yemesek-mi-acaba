...
WHERE "key" = 'community_guidelines'
  AND "body" = 'Hakaret yok. Kişisel veri yok. Fotoğraf ve fiş zorunlu. Aynı mekanı çoğaltma. İşletme yanıtı sırayı değiştirmez. Reklam veya skor satışı yoktur; çıkar çatışması bu tahtayı satın alamaz.';
