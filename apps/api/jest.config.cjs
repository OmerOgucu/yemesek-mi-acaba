...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@yemesek/mail$': '<rootDir>/../../services/mail/src/index.ts',
    '^@yemesek/badges$': '<rootDir>/../../services/badges/src/index.ts',
    '^@yemesek/settings$': '<rootDir>/../../services/settings/src/index.ts',
    '^@yemesek/admin$': '<rootDir>/../../services/admin/src/index.ts',
